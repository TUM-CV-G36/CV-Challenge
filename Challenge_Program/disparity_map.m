...
function [DbasicSubpixel] = disparity_map(I1_Rec,I2_Rec,varargin)
%% Input Parser
P = inputParser;
P.addOptional('disparityRange',16,@isnumeric);
P.addOptional('halfBlockSize',2,@isnumeric);
P.parse(varargin{:});

disparityRange = P.Results.disparityRange;
halfBlockSize = P.Results.halfBlockSize;
